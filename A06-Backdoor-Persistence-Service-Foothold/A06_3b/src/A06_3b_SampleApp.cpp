...
void WriteBeaconLog(const wchar_t *message)
{
    ...
    wchar_t logPath[MAX_PATH] = L"C:\\Users\\Public\\A06_3b_COM_Event_Triggered_Scheduled_Task_SampleApp_log.txt";
...
int APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    WriteBeaconLog(L"SampleApp initialized successfully via A06_3b COM Event-Triggered (Firefox Launch) Scheduled Task.");
    ...
    while (TRUE)
    {
        ...
        WriteBeaconLog(L"Beacon: A06_3b COM Event-Triggered Task process is alive and looping.");
    }
