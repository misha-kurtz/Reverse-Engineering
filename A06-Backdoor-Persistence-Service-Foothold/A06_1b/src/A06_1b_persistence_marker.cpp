...
static void WriteMarkerFile()
{
    ...
    oss << "THESIS_A06_1B_OFFLINE_HIVE_SAVE_RESTORE_PERSISTENCE_TRIGGERED\r\n";
    ...
    OutputDebugStringA(
        "THESIS_A06_1B_OFFLINE_HIVE_SAVE_RESTORE_PERSISTENCE_TRIGGERED");
}
